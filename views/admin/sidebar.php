<div class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="?page=admin_email_templates" class="nav-item <?= ($_GET['page'] ?? '') == 'admin_email_templates' ? 'active' : ''; ?>">
        ...
        <a href="?page=admin_audit_logs" class="nav-item <?= ($_GET['page'] ?? '') == 'admin_audit_logs' ? 'active' : ''; ?>">
